...
export type Token_Filter = {
  ...
  totalTokenPooledAmount_not_in?: InputMaybe<
    Array<Scalars['BigDecimal']['input']>
  >;
  ...
  totalValuePooledUsd_not_in?: InputMaybe<
    Array<Scalars['BigDecimal']['input']>
  >;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'hourlyDataStartTimestamp' },
          },
          type: {
            kind: 'NonNullType',
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'dailyDataStartTimestamp' },
          },
          type: {
            kind: 'NonNullType',
            type: {
                        ...
                        fields: [
                          {
                            ...
                            value: {
                              ...
                              name: {
                                kind: 'Name',
                                value: 'hourlyDataStartTimestamp',
                              },
                            },
                          },
                        ],
...
export type GetPoolsQueryVariables = Exact<{
  ...
  hourlyDataStartTimestamp: Scalars['BigInt']['input'];
  dailyDataStartTimestamp: Scalars['BigInt']['input'];
}>;
